  ...
  <div class="card border-primary mb-3">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item" ><a data-toggle="collapse" href="#collapseExample" class="all-category-filter">All Category <span class="badge badge-primary all-category" style="float:right;">0</span></a>
            ...
            <li class="list-group-item">
              <a href="javascript:;" class="category-filter" value="I was offered a bribe">
            ...
            <li class="list-group-item">
              <a href="javascript:;" class="category-filter" value="I received a bribe">
                I received a bribe
            ...
            <li class="list-group-item">
              <a href="javascript:;" class="category-filter" value="I witnessed a bribe">
                I witnessed a bribe
